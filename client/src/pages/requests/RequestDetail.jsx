          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  setAssignData((prev) => ({ ...prev, developerId: e.target.value }))
                }
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  setAssignData((prev) => ({ ...prev, estimatedPrice: e.target.value }))
                }
                className="input-field"
                placeholder="0.00"
              />
