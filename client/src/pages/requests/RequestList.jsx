            ...
            <div className="flex gap-1 overflow-x-auto pb-1">
                {STATUS_TABS.map(tab => (
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-lg whitespace-nowrap transition-all ${statusFilter === tab.key
                ...
                <div className="space-y-2">
                    {data.requests.map(req => (
                        ...
                        >
                            ...
                            <svg className="w-4 h-4 text-gray-300 dark:text-gray-600 group-hover:text-gray-500 flex-shrink-0 ml-4 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
