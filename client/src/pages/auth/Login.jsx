    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-hero-pattern relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/2 left-1/3 w-32 h-32 bg-primary-300/10 rounded-full blur-2xl animate-float" style={{ animationDelay: '1.5s' }} />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          ...
          <h1 className="text-4xl xl:text-5xl font-bold text-white leading-tight mb-6">
            Build your digital
            <br />
            <span className="text-primary-200">vision with us.</span>
          </h1>
          <p className="text-primary-100/80 text-lg max-w-md">
            Connect with expert developers and designers for App Development,
            Web Development, and Branding projects.
          </p>

          {/* Testimonial */}
          <div className="mt-12 p-6 bg-white/10 backdrop-blur-md rounded-2xl border border-white/10 max-w-md">
            <p className="text-white/90 text-sm italic">
              "SkyWorld transformed our digital presence. Their team delivered beyond expectations."
            </p>
            <div className="flex items-center mt-4">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-primary-300 to-accent-400 flex items-center justify-center text-white text-xs font-bold">A</div>
              <div className="ml-3">
                <p className="text-white text-sm font-medium">Happy Client</p>
                <p className="text-primary-200 text-xs">CEO, TechCorp</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-surface-50 text-gray-400 font-medium">or</span>
              </div>
            </div>
