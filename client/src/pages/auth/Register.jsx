        ...
        <div className="w-full max-w-sm">
          ...
          {!otpStep ? (
            <>
              ...
              <p className="mt-1.5 text-sm text-gray-500">Enter details and verify your email with OTP.</p>
              ...
              <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
                ...
                <div>
                  ...
                  <input id="email" name="email" type="email" autoComplete="email" required className="input-field" placeholder="you@example.com" value={formData.email} onChange={handleChange} />
                </div>
