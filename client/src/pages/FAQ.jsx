    ...
    <div className="min-h-screen bg-surface-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto card sm:p-12 animate-fade-in">
        ...
        <div className="space-y-3">
          {FAQ_ITEMS.map((item) => (
            <details key={item.q} className="group rounded-xl border border-gray-200 bg-white p-4 open:border-primary-200:border-primary-500/30 open:bg-primary-50/20:bg-primary-500/5">
