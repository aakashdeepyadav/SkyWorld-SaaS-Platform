    ...
    const Toggle = ({ checked, onChange, label, desc }) => (
        <div className="flex items-center justify-between py-3">
            ...
            <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none ${checked ? 'bg-primary-500' : 'bg-gray-200'
                    }`}
            >
                ...
                <div className="flex-1">
                        ...
                        <div className="card animate-fade-in">
                            ...
                            {user?.authMethod === 'google' ? (
                                <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl flex items-start">
                                    ...
                                    <div>
                                        <p className="font-medium text-blue-900 text-sm">Google Account</p>
                                        <p className="text-xs text-blue-700 mt-0.5">Your account is linked to Google. Password is managed through your Google account.</p>
                                    </div>
                                </div>
                            ) : (
                    ...
                    {activeTab === 'danger' && (
                        <div className="card border-red-200 bg-red-50/30 animate-fade-in">
                            ...
                            <p className="text-sm text-red-600/70 mb-6">Irreversible and destructive actions</p>
