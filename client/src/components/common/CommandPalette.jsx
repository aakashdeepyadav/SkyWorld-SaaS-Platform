...
const CommandPalette = () => {
    ...
    const allCommands = useMemo(() => [
        ...
        { name: 'Custom Requests', path: '/custom-requests', section: 'Navigation', hidden: user?.role === 'developer' },
        { name: 'Payments', path: '/payments', section: 'Navigation', hidden: user?.role === 'developer' },
        { name: 'New Request', path: '/requests/new', section: 'Actions', hidden: user?.role === 'developer' },
        { name: 'Custom Request', path: '/custom-request', section: 'Actions', hidden: user?.role === 'developer' },
                        ...
                        {filtered.length === 0 ? (
                            ...
                            filtered.map((cmd, i) => (
                                <button
                                    ...
                                    className={`w-full flex items-center justify-between px-4 py-2.5 text-sm transition-colors ${i === selectedIndex
